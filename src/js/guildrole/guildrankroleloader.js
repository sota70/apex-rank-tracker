...
var GuildRankRoleLoader = /** @class */ (function (_super) {
    ...
    GuildRankRoleLoader.prototype.fetchApexBattleRoyalRankRoleFromName = function (rankName) {
        var roleName = rankroles_1.BATTLE_ROYAL_RANK_ROLE_NAMES.get(rankName);
        if (roleName === undefined)
            return undefined;
        return this.fetchRoleFromName(roleName);
    };
    GuildRankRoleLoader.prototype.fetchApexArenaRankRoleFromName = function (rankName) {
        var roleName = rankroles_1.ARENA_RANK_ROLE_NAMES.get(rankName);
        if (roleName === undefined)
            return undefined;
        return this.fetchRoleFromName(roleName);
    };
