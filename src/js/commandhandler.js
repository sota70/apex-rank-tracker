...
var CommandHandler = /** @class */ (function () {
    ...
    CommandHandler.prototype.handleApexCommand = function () {
    ...
    CommandHandler.prototype.handleSetCommandChannelCommand = function () {
        var _a = this.interaction, options = _a.options, guild = _a.guild;
    ...
    CommandHandler.prototype.handleTimerStartCommand = function () {
        var client = this.interaction.client;
